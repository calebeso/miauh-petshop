        ...
        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 font-weight-bold">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('costumer.create') }}">
                    <span class="fa fa-plus-circle"></span> {{__('Cadastrar clientes')}}
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('costumer.create') }}">
                    <span class="fa fa-plus-circle"></span> {{__('Cadastrar usuário')}}
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                         document.getElementById('logout-form').submit();" class="nav-link"><span class="fa fa-paper-plane mr-3"></span> Logout</a>
